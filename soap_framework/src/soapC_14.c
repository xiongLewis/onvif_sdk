...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_tt__VideoEncoder2ConfigurationOptions(struct soap *soap, struct tt__VideoEncoder2ConfigurationOptions *a)
{
	...
	a->BitrateRange = NULL;
	soap_default_tt__IntList(soap, &a->GovLengthRange);
	soap_default_tt__FloatList(soap, &a->FrameRatesSupported);
...
{
	if (a->GovLengthRange)
		soap_set_attr(soap, "GovLengthRange", soap_tt__IntList2s(soap, a->GovLengthRange), 1);
	if (a->FrameRatesSupported)
		soap_set_attr(soap, "FrameRatesSupported", soap_tt__FloatList2s(soap, a->FrameRatesSupported), 1);
...
SOAP_FMAC3 struct tt__VideoEncoder2ConfigurationOptions * SOAP_FMAC4 soap_in_tt__VideoEncoder2ConfigurationOptions(struct soap *soap, const char *tag, struct tt__VideoEncoder2ConfigurationOptions *a, const char *type)
{
	...
	if (soap_s2tt__IntList(soap, soap_attr_value(soap, "GovLengthRange", 1, 0), &a->GovLengthRange))
		return NULL;
	if (soap_s2tt__FloatList(soap, soap_attr_value(soap, "FrameRatesSupported", 1, 0), &a->FrameRatesSupported))
		return NULL;
